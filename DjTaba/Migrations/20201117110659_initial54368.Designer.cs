...
namespace DjTaba.Migrations
{
    ...
    [Migration("20201117110659_initial54368")]
    partial class initial54368
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DjTaba.Models.ClientToPudcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PudcastId")
                        .HasColumnType("int");

                    b.HasKey("Id");

                    b.HasIndex("PudcastId");

                    b.ToTable("ClientToPudcasts");
                });
            ...
            modelBuilder.Entity("DjTaba.Models.Dj", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DjTaba.Models.DjImages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DjTaba.Models.GenreToAlbum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("GenreToAlbums");
                });

            modelBuilder.Entity("DjTaba.Models.GenreToPlaylist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("GenreToPlaylists");
                });

            modelBuilder.Entity("DjTaba.Models.GenreToPudcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DjTaba.Models.MusicToAlbum", b =>
                {
                    ...
                    b.Property<string>("MusicThumbNailPicture")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("DjTaba.Models.Pudcast", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DjTaba.Models.PudcastToMusic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("DjTaba.Models.ClientToPudcast", b =>
                {
                    b.HasOne("DjTaba.Models.Pudcast", "Pudcast")
                        .WithMany()
                        .HasForeignKey("PudcastId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
